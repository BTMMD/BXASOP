...
.. raw:: html
   ...
   <img src="_images/logo.png" alt="logo" onclick="window.open('_images/logo.png', '_blank');">

.. role:: new-window-img
   :html: <a href="{}" target="_blank" rel="noopener noreferrer"><img src="{}" alt="{}"></a>
   :new-window-img:`_images/logo.png, _images/logo.png, logo`
