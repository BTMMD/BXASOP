...
.. raw:: html
   ...
   <a href="#" onclick="showLargeImage()">
       <img src="_images/logo.jpg" alt="小图片" style="width: 200px;">
   </a>
   <div id="large-img-container" style="display: none;">
       <img id="large-img" class="centered-img" src="_images/logo.jpg" alt="大图片">
   </div>
   <script>
       function showLargeImage() {
           var largeImgContainer = document.getElementById('large-img-container');
...
.. raw:: html
   ...
   <a href="_images/logo.jpg" target="_blank" rel="noopener noreferrer">
       <img src="_images/logo.jpg" alt="图片描述" style="width: 300px;">
   </a>
   <br>
